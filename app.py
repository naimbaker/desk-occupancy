...
desk_zones = {
    ...
    'cam2': {
        'Desk 10': [0.05, 0.05, 0.50, 0.35],
        'Desk 11': [0.05, 0.37, 0.50, 0.62],
        'Desk 12': [0.05, 0.64, 0.50, 0.95],
        'Desk 13': [0.50, 0.05, 0.95, 0.35],
        'Desk 14': [0.50, 0.37, 0.95, 0.62],
        'Desk 15': [0.50, 0.64, 0.95, 0.95],
    },
    'cam3': {
