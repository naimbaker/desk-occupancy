...
desk_zones = {
    ...
    'cam2': {
        'Desk 5': [0.05, 0.05, 0.50, 0.35],
        'Desk 6': [0.05, 0.37, 0.50, 0.62],
        'Desk 7': [0.05, 0.64, 0.50, 0.95],
        'Desk 8': [0.50, 0.05, 0.95, 0.35],
        'Desk 9': [0.50, 0.37, 0.95, 0.62],
        'Desk 10': [0.50, 0.64, 0.95, 0.95],
    },
    'cam3': {
        'Desk 11': [0.0, 0.0, 0.5, 0.5],
        'Desk 12': [0.5, 0.0, 1.0, 0.5],
        'Desk 13': [0.0, 0.5, 0.5, 1.0],
        'Desk 14': [0.5, 0.5, 1.0, 1.0],
    }
}
