...
desk_zones = {
    ...
    'cam2': {
    'Desk 1': [0.05, 0.05, 0.40, 0.30],
    'Desk 2': [0.05, 0.37, 0.40, 0.62],
    'Desk 3': [0.05, 0.69, 0.40, 0.95],
    'Desk 4': [0.60, 0.05, 0.95, 0.30],
    'Desk 5': [0.60, 0.37, 0.95, 0.62],
    'Desk 6': [0.60, 0.69, 0.95, 0.95],
}
}
